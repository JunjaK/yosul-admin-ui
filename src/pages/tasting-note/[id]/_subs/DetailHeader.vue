...
import { useMajorDetailStore, useMajorFormStore } from './tastingNoteDetail';
    ...
    <n-card hoverable>
      ...
      <div class="action-buttons">
        <template v-if="majorDetail.editMode">
          <n-button
            type="error"
            @click="majorForm.checkDeleteTastingNote"
          >
            삭제
          </n-button>
          <n-button
            type="primary"
            @click="majorForm.onSubmit"
          >
            저장
          </n-button>
          <n-button
            @click="majorDetail.toggleEditMode"
          >
            취소
          </n-button>
        </template>
